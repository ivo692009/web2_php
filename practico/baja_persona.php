<?php
    ...
    try {
        ...
        //armamos el SQL
        $sql = "SELECT clientes.id, clientes.nombre, clientes.apellido, clientes.activo, clientes.fechnac, nacionalidades.descripcion  FROM clientes JOIN nacionalidades ON clientes.nacionalidad_id=nacionalidades.id WHERE clientes.id=:id";
